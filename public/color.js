console.log('hiiiiiibbbbbbbbbbbbbbbbbbbbbbbbbbbbbiiiiiiiiiiiiiiii');


// var ColorThief = require('color-thief');
//   var chromatism = require('chromatism');
console.log(chromatism, "workinggggggggggg");
...
console.log("primecolor",primeColor);
 let test = colorPalette.forEach(colour =>{
chromatism.complementary(colour).rgb
  })
